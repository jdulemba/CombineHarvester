...
for key, submit in block_map.iteritems():
	...
	num_pt_comp = 3 # number of points on either side of point to be used for finding mean, stdev
		...
		##### try my outlier removal
                ...
                if cls_val < 0.05 and cls_vals[i_val-1] > 0.05:
                    ...
                    if abs(cls_val - cls_vals[i_val-1]) > 0.035:
                        ...
                        if i_val > len(cls_vals) - 3:
                            ...
                            continue
			#if cls_vals[i_val-1] in outliers_cls and z_scores[i_val] < 2.0:
			#    print 'Previous point was outlier and current z-score < 2.0, continue'
			#    continue
                        elif cls_val < cls_vals[i_val+1]:
		    ...
		    #set_trace()
        	    #if (parity, mass, width) == ('A', '550', '5'): set_trace()
        ...
        #if (parity, mass, width) == ('H', '450', '25'): set_trace()
